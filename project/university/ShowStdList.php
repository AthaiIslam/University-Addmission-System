...
// $sql = "SELECT u.*, s.*, FROM university AS u  LEFT JOIN student AS r ON u.uni_id = s.uni_id GROUP BY u.uni_name ORDER BY u.uni_name DESC" ;

$sql = "SELECT * FROM university RIGHT JOIN student ON student.uni_id = university.uni_id WHERE student.uni_id = $uni_id";

// $sql = "SELECT u.*, s.*,  FROM student AS s  JOIN university  AS u ON u.uni_id = s.uni_id " ;

// $sql = "SELECT university.*,  student.*, FROM university   LEFT JOIN student  ON   student.uni_id = university.uni_id GROUP BY student.student_id" ;
...
<div class="container">
    ...
    <form method="POST" action="search-by-department.php">
    ...
    <form method="POST" action="search-by-gpa.php">
